...
export const UI_STRINGS: Record<string, any> = {
  en: { 
    ...
    live: "Listening", tapMic: "Tap Mic", tapMicToSpeak: "Tap Mic to Speak", back: "Back",
  ...
  zh: { 
    ...
    live: "聆听中", tapMic: "点击录音", tapMicToSpeak: "点击麦克风开始说话", back: "返回",
    noInput: "未检测到语音输入。"
  },
  ja: { 
    ...
    live: "聴取中", tapMic: "マイクをタップ", tapMicToSpeak: "マイクをタップして話す", back: "戻る",
  ...
  ko: { 
    ...
    live: "듣는 중", tapMic: "마이크 누르기", tapMicToSpeak: "마이크를 눌러 말하기", back: "뒤로",
  ...
  th: { 
    ...
    live: "กำลังฟัง", tapMic: "แตะไมค์", tapMicToSpeak: "แตะไมค์เพื่อพูด", back: "กลับ",
  ...
  vi: { 
    ...
    live: "Đang nghe", tapMic: "Chạm mic", tapMicToSpeak: "Chạm mic để nói", back: "Quay lại",
  ...
  id: { 
    ...
    live: "Mendengarkan", tapMic: "Ketuk Mik", tapMicToSpeak: "Ketuk mik untuk bicara", back: "Kembali",
  ...
  ms: { 
    ...
    live: "Mendengar", tapMic: "Ketik Mik", tapMicToSpeak: "Ketik mik untuk bercakap", back: "Kembali",
  ...
  es: { 
    ...
    live: "Escuchando", tapMic: "Tocar Mic", tapMicToSpeak: "Toca el micro para hablar", back: "Volver",
  ...
  fr: { 
    ...
    live: "Écoute", tapMic: "Appuyez Mic", tapMicToSpeak: "Appuyez sur le micro pour parler", back: "Retour",
  ...
  de: { 
    ...
    live: "Zuhören", tapMic: "Mikro tippen", tapMicToSpeak: "Mikrofon zum Sprechen tippen", back: "Zurück",
